...
component accessors="true" singleton {
	...
	this.$executors = new logbox.system.async.executors.ExecutorBuilder();
	 ...
	 *
	 * @return The ColdBox Schedule class to work with the schedule: logbox.system.async.executors.Executor
	 */
	 ...
	 *
	 * @return The executor object: logbox.system.async.executors.Executor
	 *
	...
	Scheduler function newScheduler( required name ){
		return new logbox.system.async.tasks.Scheduler( arguments.name, this );
	}
